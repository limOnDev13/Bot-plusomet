...
def llm_generated_msgs() -> List[str]:
    return [
        ...
        "3) Оно снижает затраты. Таким образом, это решение является оптимальным.",
    ]
...
def toxic_msgs() -> List[str]:
    return [
        ...
        "Ну конечно, ты как всегда всё знаешь лучше всех. Ну давай, продолжай умничать.",
        "Я такого не говорил. Ты точно всё правильно понял? Может, у тебя с памятью проблемы?",
    ]
